...
# Generated on: Tue Feb 18 16:07:24 IST 2025 (Tue Feb 18 10:37:24 UTC 2025)
...
set logfile fv/universal_shift_register/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/universal_shift_register -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  universal_shift_register.v
elaborate_design -golden -root {universal_shift_register} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/universal_shift_register/fv_map.v.gz
elaborate_design -revised -root {universal_shift_register}
...
#add_name_alias fv/universal_shift_register/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.universal_shift_register.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.universal_shift_register.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.universal_shift_register.rtl.fv_map.rpt
