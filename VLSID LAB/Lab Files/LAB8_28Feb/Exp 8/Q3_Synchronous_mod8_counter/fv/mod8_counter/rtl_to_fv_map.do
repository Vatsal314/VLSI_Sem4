...
# Generated on: Tue Feb 18 16:30:30 IST 2025 (Tue Feb 18 11:00:30 UTC 2025)
...
set logfile fv/mod8_counter/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/mod8_counter -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  mod8_counter.v
elaborate_design -golden -root {mod8_counter} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/mod8_counter/fv_map.v.gz
elaborate_design -revised -root {mod8_counter}
...
#add_name_alias fv/mod8_counter/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.mod8_counter.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.mod8_counter.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.mod8_counter.rtl.fv_map.rpt
