...
# Generated on: Tue Feb 18 15:00:54 IST 2025 (Tue Feb 18 09:30:54 UTC 2025)
...
set logfile fv/pipo_seq/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/pipo_seq -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  pipo_seq.v
elaborate_design -golden -root {pipo_seq} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/pipo_seq/fv_map.v.gz
elaborate_design -revised -root {pipo_seq}
...
#add_name_alias fv/pipo_seq/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.pipo_seq.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.pipo_seq.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.pipo_seq.rtl.fv_map.rpt
