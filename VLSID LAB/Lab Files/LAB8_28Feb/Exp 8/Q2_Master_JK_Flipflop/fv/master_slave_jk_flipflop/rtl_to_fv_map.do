...
# Generated on: Tue Feb 18 16:21:11 IST 2025 (Tue Feb 18 10:51:11 UTC 2025)
...
set logfile fv/master_slave_jk_flipflop/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/master_slave_jk_flipflop -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  master_slave_jk_flipflop.v
elaborate_design -golden -root {master_slave_jk_flipflop} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/master_slave_jk_flipflop/fv_map.v.gz
elaborate_design -revised -root {master_slave_jk_flipflop}
...
#add_name_alias fv/master_slave_jk_flipflop/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.master_slave_jk_flipflop.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.master_slave_jk_flipflop.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.master_slave_jk_flipflop.rtl.fv_map.rpt
