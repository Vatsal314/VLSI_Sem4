...
# Generated on: Sat Mar 01 14:37:45 IST 2025 (Sat Mar 01 09:07:45 UTC 2025)
...
set logfile fv/q/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/q -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  q.v
elaborate_design -golden -root {q} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/q/fv_map.v.gz
elaborate_design -revised -root {q}
...
set_system_mode lec
write_compared_points noneq.compared_points.q.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.q.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.q.rtl.fv_map.rpt
