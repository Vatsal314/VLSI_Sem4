...
# Generated on: Sat Mar 01 14:26:41 IST 2025 (Sat Mar 01 08:56:41 UTC 2025)
...
set logfile fv/fa/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/fa -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  fa.v
elaborate_design -golden -root {fa} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/fa/fv_map.v.gz
elaborate_design -revised -root {fa}
...
set_system_mode lec
write_compared_points noneq.compared_points.fa.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.fa.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.fa.rtl.fv_map.rpt
