...
# Generated on: Sat Mar 01 14:57:26 IST 2025 (Sat Mar 01 09:27:26 UTC 2025)
...
set logfile fv/q_gate/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/q_gate -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  q_gate.v
elaborate_design -golden -root {q_gate} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/q_gate/fv_map.v.gz
elaborate_design -revised -root {q_gate}
...
set_system_mode lec
write_compared_points noneq.compared_points.q_gate.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.q_gate.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.q_gate.rtl.fv_map.rpt
