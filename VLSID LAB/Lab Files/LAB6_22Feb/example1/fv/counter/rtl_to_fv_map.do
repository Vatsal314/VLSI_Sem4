...
# Generated on: Sat Feb 22 15:48:07 IST 2025 (Sat Feb 22 10:18:07 UTC 2025)
...
set logfile fv/counter/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/counter -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  counter.v
elaborate_design -golden -root {counter} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/counter/fv_map.v.gz
...
#add_name_alias fv/counter/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.counter.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.counter.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.counter.rtl.fv_map.rpt
