...
# Generated on: Sat Feb 22 16:11:53 IST 2025 (Sat Feb 22 10:41:53 UTC 2025)
...
set logfile fv/fulladder/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/fulladder -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  fulladder.v
elaborate_design -golden -root {fulladder} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/fulladder/fv_map.v.gz
elaborate_design -revised -root {fulladder}
...
set_system_mode lec
write_compared_points noneq.compared_points.fulladder.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.fulladder.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.fulladder.rtl.fv_map.rpt
