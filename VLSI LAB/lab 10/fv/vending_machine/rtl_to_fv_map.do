...
# Generated on: Tue Mar 25 14:48:29 IST 2025 (Tue Mar 25 09:18:29 UTC 2025)
...
set logfile fv/vending_machine/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/vending_machine -revised fv_map
...
elaborate_design -golden -root {vending_machine} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/vending_machine/fv_map.v.gz
elaborate_design -revised -root {vending_machine}
...
#add_name_alias fv/vending_machine/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.vending_machine.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.vending_machine.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.vending_machine.rtl.fv_map.rpt
